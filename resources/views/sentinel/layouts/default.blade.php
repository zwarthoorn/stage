	      ...
	      <div class="container">
	        ...
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
				...
				@endif
				@if(Sentry::check() && Sentry::getUser()->hasAccess('bedrijf'))
					<li {{ (Request::is('bedrijven*') ? 'class="active"' : '') }}><a href="/bedrijven">Bedrijven</a></li>
				@endif
				@if(Sentry::check() && Sentry::getUser()->hasAccess('tools'))
					<li {{ (Request::is('tools*') ? 'class="active"' : '') }}><a href="/tools">Tools/Techniek</a></li>
				@endif
	          </ul>
